...
public class CSVBodyWriter implements MessageBodyWriter {
    ...
    @Override
    public void writeTo(Object o, Class aClass, Type type, Annotation[] annotations, MediaType mediaType, MultivaluedMap multivaluedMap, OutputStream entityStream) throws IOException, WebApplicationException {
    ...
    private String createCsvRow(Object o) {
        String row = "";
